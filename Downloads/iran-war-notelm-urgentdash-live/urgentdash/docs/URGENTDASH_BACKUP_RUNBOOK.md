...
> 대상: `dashboard_bundle/scripts/backup_urgentdash.py`로 urgentdash 스냅샷을 백업/복구 점검하는 운영 절차
...
참고 예제: `dashboard_bundle/ui/urgentdash_snapshot.example.json`
...
# 명시적 파일 경로 사용
python dashboard_bundle/scripts/backup_urgentdash.py dashboard_bundle/ui/urgentdash_snapshot.example.json
```
