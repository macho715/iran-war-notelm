...
async def test_hourly_job_sends_immediate_alert_on_high(monkeypatch):
    ...
    monkeypatch.setattr(main, "scrape_rss", fake_scrape_rss)
    ...
    monkeypatch.setattr(main, "_write_health_state", lambda *args, **kwargs: None)
    monkeypatch.setattr(main, "_save_report_archive", lambda *args, **kwargs: None)
