...
def build_article_rows(*, articles: list[dict], run_ts: str) -> list[dict]:
    ...
    for article in articles:
        canonical_url = str(article.get("canonical_url") or article.get("link") or "").strip()
        ...
        rows.append(
            {
                ...
                "city": str(article.get("city") or _city_from_article(article)),
                "tier": str(article.get("tier") or _tier_from_article(article)),
